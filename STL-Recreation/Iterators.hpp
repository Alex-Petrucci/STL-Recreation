...
namespace stlr
{
	...
	public:
		...
		constexpr ReverseIterator& operator++() { --m_iterator; return *this; }
		constexpr ReverseIterator& operator--() { ++m_iterator; return *this; }
		...
		[[nodiscard]] constexpr ReverseIterator operator+(difference_type n) const { return ReverseIterator{ m_iterator - n }; }
		[[nodiscard]] constexpr ReverseIterator operator-(difference_type n) const { return ReverseIterator{ m_iterator + n }; }
		constexpr ReverseIterator& operator+=(difference_type n) { return *this = *this + n; }
		constexpr ReverseIterator& operator-=(difference_type n) { return *this = *this - n; }

		constexpr reference operator[](difference_type n) const { return *(*this + n); }

		[[nodiscard]] constexpr difference_type operator-(const ReverseIterator& other) const { return other.m_iterator - m_iterator; }
